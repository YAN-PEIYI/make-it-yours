        ...
        jQuery.fn.poptrox = function(options) {
                ...
                // Settings
                        ...
                        var settings = jQuery.extend({
                                        ...
                                        popupBackgroundColor:                   '#F5F5F5',                                              // (Default Style) Popup background color (when usePopupStyling = true)
                                        popupTextColor:                                 '#F5F5F5',                                              // (Default Style) Popup text color (when usePopupStyling = true)
